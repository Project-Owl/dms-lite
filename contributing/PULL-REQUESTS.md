...
* [Reviewing pull requests](#reviewing-pull-requests)
  ...
  * [Accept that there are different opinions about what belongs in dms-lite](#accept-that-there-are-different-opinions-about-what-belongs-in-dms-lite)
...
More details to come on dms-lite dependencies. In case of doubt, open an issue in the
[issue tracker](https://github.com/Project-Owl/dms-lite/issues/) or engage on the
[dms-lite Slack workspace][].
...
Fork the project [on GitHub](https://github.com/Project-Owl/dms-lite) and clone your fork
locally.

```text
$ git clone git@github.com:username/dms-lite.git
$ cd dms-lite
$ git remote add upstream https://github.com/Project-Owl/dms-lite.git
$ git fetch upstream
```
...
dms-lite does not yet have a style guide. If you're interested in creating one, you're on the right page 😃
...
Fixes: https://github.com/Project-Owl/dms-lite/issues/1337
Refs: http://eslint.org/docs/rules/space-in-parens.html
```

If you are new to contributing to dms-lite, please try to do your best at
...
at least one dms-lite Collaborators. After that, as long as there are no
...
All dms-lite contributors who choose to review and provide feedback on pull
...
1. Does this change make sense for dms-lite?
2. Does this change make dms-lite better, even if only incrementally?
...
dms-lite Collaborator landing the pull request but they can also be an
...
a particular change that makes dms-lite better, but the individual might just
not want to have anything to do with dms-lite ever again. The goal is not just
having good code.
...
Any dms-lite core Collaborator (any GitHub user with commit rights in the
`Project-Owl/dms-lite` repository) is authorized to approve any other contributor's
...
### Accept that there are different opinions about what belongs in dms-lite

Opinions on this vary, even among the members of the Technical Steering
Committee.

One general rule of thumb is that if dms-lite itself needs it (due to historic
or functional reasons), then it belongs in dms-lite.
...
make dms-lite better. These may or may not make sense to add, but as with all
...
dms-lite has always optimized for speed of execution. If a particular change
can be shown to make some part of dms-lite faster, it's quite likely to be
...
That said, performance is not the only factor to consider. dms-lite also
...
to make sure that it works on the platforms that dms-lite
...
[Code of Conduct]: https://github.com/Project-Owl/dms-lite/blob/master/CONTRIBUTING.md#code-of-conduct
[Collaborator Guide]: https://github.com/Project-Owl/dms-lite/blob/master/CONTRIBUTING.md
[dms-lite Slack workspace]: https://www.project-owl.com/slack